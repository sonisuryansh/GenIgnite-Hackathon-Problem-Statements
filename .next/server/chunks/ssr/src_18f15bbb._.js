...
function NftPage({ params }) {
    ...
    const formattedDates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!isClient || !nft || nft.owners.length <= 1) return [];
        const reversedOwners = [
            ...nft.owners
        ].reverse();
        return reversedOwners.slice(1).map((owner)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(owner.timestamp), "PPp"));
    }, [
        nft,
        isClient
    ]);
...
//# sourceMappingURL=src_18f15bbb._.js.map