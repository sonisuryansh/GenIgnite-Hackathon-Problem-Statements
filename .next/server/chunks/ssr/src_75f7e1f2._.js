...
function useNftStore() {
    ...
    const addNft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((newNftData)=>{
        ...
        // Generate hash client-side to avoid hydration mismatch
    ...
    const transferNft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((hash, newOwnerAddress)=>{
        const currentNfts = JSON.parse(localStorage.getItem(NFT_STORAGE_KEY) || '[]');
        const nftToTransfer = currentNfts.find((nft)=>nft.hash === hash);
        if (!nftToTransfer) return false;
        const updatedNfts = currentNfts.map((nft)=>nft.hash === hash ? {
                ...nft,
                owners: [
                    ...nft.owners,
                    {
...
//# sourceMappingURL=src_75f7e1f2._.js.map