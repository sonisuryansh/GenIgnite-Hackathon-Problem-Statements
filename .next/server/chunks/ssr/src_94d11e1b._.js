...
// A function to generate a random hash, safe for SSR
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        try {
            ...
            if (storedNfts) {
                ...
                // Initialize with empty array if nothing is in localStorage
                localStorage.setItem(NFT_STORAGE_KEY, JSON.stringify([]));
                setNfts([]);
            }
        } catch (error) {
            console.error('Failed to access localStorage:', error);
            // Fallback to an empty array in case of any error
            setNfts([]);
        } finally{
            setIsLoaded(true);
        }
...
//# sourceMappingURL=src_94d11e1b._.js.map